...
export const NEXT_PUBLIC_API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:3001';
...
export const DISCOGS_USER_AGENT = process.env.DISCOGS_USER_AGENT || 'SonoSphere/0.1 (https://your.app.url)';
...
export const NEXT_PUBLIC_SPOTIFY_REDIRECT_URI = process.env.NEXT_PUBLIC_SPOTIFY_REDIRECT_URI;
...
export const NEXT_PUBLIC_LASTFM_CALLBACK_URL = process.env.NEXT_PUBLIC_LASTFM_CALLBACK_URL;

// MusicBrainz API Configuration
export const MUSICBRAINZ_USER_AGENT = process.env.NEXT_PUBLIC_MUSICBRAINZ_USER_AGENT || 'SonoSphere/0.1 ( mailto:your-email@example.com ) Tell MusicBrainz who you are!';
...
export const NEXT_PUBLIC_APPLE_DEVELOPER_TOKEN = process.env.NEXT_PUBLIC_APPLE_DEVELOPER_TOKEN;
