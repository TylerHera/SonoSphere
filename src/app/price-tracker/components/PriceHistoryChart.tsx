...
export function PriceHistoryChart({ itemId, priceData = MOCK_PRICE_DATA }: PriceHistoryChartProps) {
      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={priceData}>
            ...
            <Legend />
            <Line type="monotone" dataKey="price" stroke="#8884d8" activeDot={{ r: 8 }} name="Price (USD)" />
          </LineChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
