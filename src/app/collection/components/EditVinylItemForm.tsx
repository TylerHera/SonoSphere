...
interface UpdateVinylItemPayload
  extends Partial<
    Omit<VinylItemFromAPI, 'id' | 'userId' | 'added_at' | 'updated_at'>
  > {
  folder?: string | null;
}
...
export function EditVinylItemForm({
  accessToken,
  item,
  onFormSubmit,
  onCancel,
  isOpen,
}: EditVinylItemFormProps) {
