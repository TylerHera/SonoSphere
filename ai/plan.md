...
- [x] 3.1.1 Integrate CamelCamelCamel and/or Keepa APIs for Amazon price history (US & UK) (Keepa client structure created in backend)
- [x] 3.1.2 Create price history charts for vinyl records (Placeholder component created)
- [x] 3.1.3 Implement price alert system ("Droplist") with notifications (Backend model, DTOs, service, controller created)
- [x] 3.1.4 Build watchlist management UI (Placeholder page created)

### 3.2 Releases Calendar

- [x] 3.2.1 Integrate MusicBrainz API for release date information (and Cover Art Archive for thumbnails)
- [x] 3.2.2 Create calendar view with cover art thumbnails
- [x] 3.2.3 Implement countdown timers for upcoming releases
- [x] 3.2.4 Add release notifications and filtering by artist/label

### 3.3 Multi-Source Playback

- [x] 3.3.1 Add Apple Music integration (Apple MusicKit JS)
- [x] 3.3.2 Implement YouTube playback for rare tracks (YouTube IFrame API)
- [x] 3.3.3 Create unified search across integrated platforms
- [x] 3.3.4 Build playback source selector UI

### 3.4 Progressive Web App (PWA) & Data Export

- [x] 3.4.1 Configure Next.js PWA support (e.g., using `next-pwa` plugin)
- [x] 3.4.2 Implement offline caching strategies for core data and recently accessed content
- [x] 3.4.3 Create CSV import/export functionality for collection data
- [x] 3.4.4 Add local storage for playback position memory ("Smart Resume")
...
- [x] 4.1.1 Integrate with Spotify Recommendations API
- [x] 4.1.2 Explore implementing custom recommendation algorithms (e.g., open-source ML, audio feature similarity)
- [x] 4.1.3 Create discovery queues and personalized playlists
- [x] 4.1.4 Add "Blasts from the Past" feature to resurface forgotten favorites

### 4.2 Gamification & Badges

- [x] 4.2.1 Design badge system for listening milestones and achievements
- [x] 4.2.2 Implement listening challenges to encourage discovery
- [x] 4.2.3 Create achievement tracking and display
- [x] 4.2.4 Allow profile customization with earned badges

### 4.3 Lyrics & Metadata Management

- [x] 4.3.1 Integrate Musixmatch API for synchronized lyrics
- [x] 4.3.2 Create karaoke-style synchronized lyrics display
- [x] 4.3.3 Implement metadata correction tools (e.g., via MusicBrainz lookup, AcoustID)
- [x] 4.3.4 Add history of metadata edits and allow user corrections

### 4.4 Advanced Playback Features

- [x] 4.4.1 Implement gapless playback using Web Audio API (POC for direct audio)
- [x] 4.4.2 Add crossfade functionality between tracks
- [x] 4.4.3 Implement audio visualization (e.g., spectrum analyzer)
- [x] 4.4.4 Implement playback speed controls

### 4.5 Continuous Improvement

- [x] 4.5.1 Set up comprehensive testing (Jest for unit/integration, Cypress for E2E)
- [x] 4.5.2 Implement monitoring with Prometheus/Grafana (if self-hosting aspects or for backend service monitoring on Render) (Notes added for Vercel/Render monitoring & Sentry)
- [x] 4.5.3 Schedule regular refactoring sprints to manage technical debt
- [x] 4.5.4 Create and maintain documentation for API and components
